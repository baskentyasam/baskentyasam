...
export const updateMyProfile = async (
  ...
  try {
    // Profil fotoğrafı base64 olarak büyük olabilir; timeout'u genişletiyoruz
    const res = await apiClient.put<MyProfile & { message?: string }>(
      '/Auth/me',
      payload,
      { timeout: 60_000 },
    );
    ...
    // Yaygın HTTP hatalarını kullanıcıya anlaşılır şekilde aktar
