                  ...
                  {filteredItems.map((item) => (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex h-14 w-14 items-center justify-center rounded-lg bg-red-50 text-3xl shrink-0">
                          {item.image}
                        </div>
                      ...
                      <div className="mt-3 flex items-center justify-between gap-2">
                        <p className="text-lg font-bold text-[#d71920] whitespace-nowrap">
                          {item.price.toFixed(2)} ₺
                        </p>
                        <button
                          onClick={() => handleAddToCart(item)}
                          className="inline-flex items-center gap-1.5 rounded-lg bg-[#d71920] px-3 py-2 text-xs font-semibold text-white hover:opacity-90 whitespace-nowrap"
                        >
                          Sepete Ekle
                          <span className="flex h-4 w-4 items-center justify-center rounded bg-white text-[#d71920] font-bold text-[10px]">
                            +
                          </span>
                        </button>
                      </div>
